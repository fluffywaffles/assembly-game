...
ml  /c  /coff  /Cp letters.asm || goto :error
ml  /c  /coff  /Cp game.asm || goto :error

d:\masm32\bin\link /SUBSYSTEM:WINDOWS  /LIBPATH:c:\masm32\lib  game.obj letters.obj input.obj blit.obj lines.obj stars.obj libgame.obj || goto :error
